(function () {
  ...
  const n     = month + day - 1;      // 항상 답이 1이 되도록
  ...
  const lines = [
    ...
    `<span class="eq-char">오</span><span class="eq-op">+</span><span class="eq-char">늘</span><span class="eq-op">−</span><span class="eq-num">${n}</span><span class="eq-eq">=</span><span class="eq-unknown">?</span>`,
  ];
